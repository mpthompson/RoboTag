...
void CCamera::GetNextFrame(void*)
{
    ...
    // Avoid getting frames too frequently.
    if (m_timeCurrFrameStamp - m_timePrevFrameStamp  < 5) return;
    ...
    if (m_isRunning)
    {
        ...
        // Get info of number of frames per second in a string for debuging/etc.
